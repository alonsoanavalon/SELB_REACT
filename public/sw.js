    ...
    evt.waitUntil(
        caches.open(cacheData).then((cache) => {
            const optionalResources = [
                ...
                '/sessions-logged',
                '/wisconsin',
                // --- WISCONSIN OFFLINE RESOURCES ---
            '/sounds/wisconsin-correct.wav',
            '/sounds/wisconsin-incorrect.wav',
            ...
            // Imágenes dinámicas de cartas (todas .png, sólo las usadas):
            '/images/wisconsin/circle_blue_1.png',
            '/images/wisconsin/circle_blue_2.png',
            '/images/wisconsin/circle_blue_3.png',
            '/images/wisconsin/circle_blue_4.png',
            '/images/wisconsin/circle_green_1.png',
            '/images/wisconsin/circle_green_2.png',
            '/images/wisconsin/circle_green_3.png',
            '/images/wisconsin/circle_green_4.png',
            '/images/wisconsin/circle_red_1.png',
            '/images/wisconsin/circle_red_2.png',
            '/images/wisconsin/circle_red_3.png',
            '/images/wisconsin/circle_red_4.png',
            '/images/wisconsin/circle_yellow_1.png',
            '/images/wisconsin/circle_yellow_2.png',
            '/images/wisconsin/circle_yellow_3.png',
            '/images/wisconsin/circle_yellow_4.png',
            '/images/wisconsin/diamond_blue_1.png',
            '/images/wisconsin/diamond_blue_2.png',
            '/images/wisconsin/diamond_blue_3.png',
            '/images/wisconsin/diamond_blue_4.png',
            '/images/wisconsin/diamond_green_1.png',
            '/images/wisconsin/diamond_green_2.png',
            '/images/wisconsin/diamond_green_3.png',
            '/images/wisconsin/diamond_green_4.png',
            '/images/wisconsin/diamond_red_1.png',
            '/images/wisconsin/diamond_red_2.png',
            '/images/wisconsin/diamond_red_3.png',
            '/images/wisconsin/diamond_red_4.png',
            '/images/wisconsin/diamond_yellow_1.png',
            '/images/wisconsin/diamond_yellow_2.png',
            '/images/wisconsin/diamond_yellow_3.png',
            '/images/wisconsin/diamond_yellow_4.png',
            '/images/wisconsin/star_blue_1.png',
            '/images/wisconsin/star_blue_2.png',
            '/images/wisconsin/star_blue_3.png',
            '/images/wisconsin/star_blue_4.png',
            '/images/wisconsin/star_green_1.png',
            '/images/wisconsin/star_green_2.png',
            '/images/wisconsin/star_green_3.png',
            '/images/wisconsin/star_green_4.png',
            '/images/wisconsin/star_red_1.png',
            '/images/wisconsin/star_red_2.png',
            '/images/wisconsin/star_red_3.png',
            '/images/wisconsin/star_red_4.png',
            '/images/wisconsin/star_yellow_1.png',
            '/images/wisconsin/star_yellow_2.png',
            '/images/wisconsin/star_yellow_3.png',
            '/images/wisconsin/star_yellow_4.png',
            '/images/wisconsin/triangle_blue_1.png',
            '/images/wisconsin/triangle_blue_2.png',
            '/images/wisconsin/triangle_blue_3.png',
            '/images/wisconsin/triangle_blue_4.png',
            '/images/wisconsin/triangle_green_1.png',
            '/images/wisconsin/triangle_green_2.png',
            '/images/wisconsin/triangle_green_3.png',
            '/images/wisconsin/triangle_green_4.png',
            '/images/wisconsin/triangle_red_1.png',
            '/images/wisconsin/triangle_red_2.png',
            '/images/wisconsin/triangle_red_3.png',
            '/images/wisconsin/triangle_red_4.png',
            '/images/wisconsin/triangle_yellow_1.png',
            '/images/wisconsin/triangle_yellow_2.png',
            '/images/wisconsin/triangle_yellow_3.png',
