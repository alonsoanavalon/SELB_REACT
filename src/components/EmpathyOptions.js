    ...
    return (
        <SwiperSlide>
            <div className="page-item">
                ...
                <form data-instrument={props.instrumentId} data-item={props.itemId} className="esc-form" onClick={props.onclick} key={props.itemId} style={{display:"flex", flexDirection:"row", flexWrap:"wrap", gap:".5rem", alignItems:"center", justifyContent:"center"}}>
