...
{/*                 <NavLink className={({isActive}) => isActive ? 'active' : ''}to="/users">
...

                {
                    ...
                    <svg  id="excel-icon"  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
{/* {
                    ...
                    <NavLink className={({isActive}) => isActive ? 'active' : ''}to="/desarrollo">
                            <svg id="development-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                {       
                    ...
                    <svg  id="moment-icon"xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
