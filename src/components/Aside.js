...
export default function Aside() {
    ...
    return (
        ...
        <Fragment> 
            {/* {
                (userRole && window.location.pathname !== '/login') && 
                userRole === (ROLES.ADMIN || ROLES.EVALUATOR) ? <div className='aside-bar aside-bar-hidden'>
...

                {
                    ...
                    <svg  id="excel-icon"  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <NavLink className={({isActive}) => isActive ? 'active' : ''}to="/report-panel">
                <svg id="parents-icon" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
